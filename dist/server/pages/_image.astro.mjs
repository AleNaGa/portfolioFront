...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_g6DNmJna.mjs'
    ).then(n => n.K).catch((e) => {
...
}, "C:/Users/Alejandro/Desktop/pruebaDespliegue/portfolioFront/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/Alejandro/Desktop/pruebaDespliegue/portfolioFront/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///C:/Users/Alejandro/Desktop/pruebaDespliegue/portfolioFront/dist/client/");
